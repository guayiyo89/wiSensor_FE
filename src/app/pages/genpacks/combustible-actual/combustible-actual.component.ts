...
@Component({
  selector: 'app-combustible-actual',
  templateUrl: './combustible-actual.component.html',
  styles: [
  ]
})
export class CombustibleActualComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    let chart = am4core.create("chartComb", am4charts.GaugeChart);
